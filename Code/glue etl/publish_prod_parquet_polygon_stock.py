...
QUERY_RESULTS_BUCKET = 's3://de-abe-project-polygon-stocks-query-result-dec2024/'
MY_DATABASE = 'de_stock_data_dec2024'
SOURCE_PARQUET_TABLE_NAME = 'de_abe_project_polygon_stocks_dec2024_pq'
NEW_PROD_PARQUET_TABLE_NAME = 'de_abe_project_polygon_stocks_dec2024_pq_PROD'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://de-abe-project-polygon-stocks-dec2024-pq-prod'
