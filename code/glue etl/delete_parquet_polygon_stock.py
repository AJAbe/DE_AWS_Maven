...
BUCKET_TO_DEL = 'de-abe-project-polygon-stocks-dec2024-pq'
DATABASE_TO_DEL = 'de_stock_data_dec2024'
TABLE_TO_DEL = 'de_abe_project_polygon_stocks_dec2024_pq'
QUERY_OUTPUT_BUCKET = 's3://de-abe-project-polygon-stocks-query-result-dec2024/'
